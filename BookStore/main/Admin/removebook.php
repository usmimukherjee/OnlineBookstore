              ...
              <nav>
                <ul class="nav masthead-nav">
                  ...
                  <li><a href="addbook.php">Add Books</a></li>
                   <li class="active"><a href="#">Remove Books</a></li>
...
<form method="POST" action="processchanges.php">
             


            <b><h4>Select Book Name:<h4></b><br><br>
            <select  name="BookName" class="tb6" required >
          ...
          $res=mysqli_query($conn,$q) or die("Can't Execute Query...");
           ...
           while ($row=mysqli_fetch_assoc($res) ) {
            # code...
               ...
               echo"<option enable>$row[BookName]";
