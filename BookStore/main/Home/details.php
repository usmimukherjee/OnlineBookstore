...
<br><br>
  ...
  $q = "select * from Books where BookName='$book' ";
  $res = mysqli_query($conn,$q) or die("Can't Execute Query..");
    ...
    <div class='flex-container' > 
        ...
        <p><img src='../$row1[BookImage]' height='300' width='200'/></p>          
          ...
          <strong><h2>$row1[BookName]</h2></strong>
          <h4>AUTHOR :$row1[AuthorName]<br></h4>
          <h4>CATEGORY : $row1[Category_name]<br></h4>
          <h4>PUBLISHER  :  $row1[PublisherName]<br></h4>
          <h4><b>DESCRIPTION </b> : $row1[Description]</h4>
          <h2>Price :&#8377 $row1[Price]</h2><br>
        </div>
          ...
          <a class='btn btn-lg btn-warning'  href ='process_cart.php?BookName=".$row1["BookName"]."&Category_name=".$row1["Category_name"]."&Price=".$row1["Price"]."'> Add to Cart </a>
           ...
           <a href='http:../$row1[Book_pdf]' class='btn btn-lg btn-info' target='_Blank'> Preview </a><br>
