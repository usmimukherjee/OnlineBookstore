          ...
          <div id="content">
            <div class="post">
                ...
                <?php
                  ...
                  { 
                    echo '
                      ...
                      <td> '.$x['Category_name'].'
                      <td> '.$x['BookName'].'
                      <td> <input style="background-color:white;"  type="text" size="2" value="'.$x['qty'].'" name="'.$id.'">
                      <td> '.$x['Price'].'
                      <td> '.($x['qty']*$x['Price']).'
                      <td> <a class="btn btn-md btn-warning" href="process_cart.php?id='.$id.'">Delete</a>
                    </tr>
                    ';
              ...
              <Br>
                ...
                <br><br>
              <center>
              <input class="btn btn-lg btn-warning" type="submit" value=" RE-CALCULATE " > 
         

              <a class="btn btn-lg btn-warning" href="checkout.php">CONFIRM & PROCEED<a/>
              </center>
              </form></div></div>
              </div>
